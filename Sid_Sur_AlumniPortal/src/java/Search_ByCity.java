 ...
 * @author USER
 */
@WebServlet(urlPatterns = {"/Search_ByCity"})
public class Search_ByCity extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String studentid = request.getParameter("userid");
         String searchfor = request.getParameter("city");
         
         String sql = "select name , studentid from student where currentcity like '"+searchfor+"' and studentid <> 'admin';"; //add clause so user cant search for himself
         ...
         try{
                        ...
                        if(!rs.first()){
                            people = "No results found. Try using a percentage symbol in your search for wildcard search.";
                        }else{
                         //   rs.first();
                            rs.beforeFirst();
                        while(rs.next()){
