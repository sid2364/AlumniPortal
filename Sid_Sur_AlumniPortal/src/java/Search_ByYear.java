 ...
 * @author USER
 */
@WebServlet(urlPatterns = {"/Search_ByYear"})
public class Search_ByYear extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        response.setContentType("text/html;charset=UTF-8");
         ...
         String sql = "select name , studentid from student where yearofgrad like '"+searchfor+"' and studentid <> 'admin';"; //add clause so user cant search for himself
