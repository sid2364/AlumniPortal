...
public class ProfilePage extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String fromstudentid = (String)request.getAttribute("fromstudentid");
        request.setAttribute("fromstudentid", fromstudentid);
        System.out.println("STUDENTID: "+studentid);
        System.out.println(studentid+" PROFILE PAGE "+fromstudentid);
        try{
            ...
            //String sql="select * from student where firstname='Sid' and lastname='Sahay'";
                    try{
                        ...
                        System.out.println(rs.getString("dob")+rs.getString("emailaddress"));
			...
			while(rs.next()){
				ann = ann + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<bold>" + rs.getString("post") + "</bold> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ";
                        ...
                        sql=" select eventname, time, date from event where eventid in (select eventid from attending where studentid='"+studentid+"')";
                        rs = stmt.executeQuery(sql);
			String events="";
			while(rs.next()){
				events = events + "<bold><u><font size='4' >" + rs.getString("eventname") + "</font></u></bold> <br>"+rs.getString("time")+"<br>"+rs.getString("date")+"<br><br>";
                        ...
                        sql="select role from login where studentid='"+studentid+"';";
                        rs = stmt.executeQuery(sql);
                        rs.first();
