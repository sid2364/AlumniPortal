...
<body class="img" style="margin: 0px; padding: 0px; font-family: 'Trebuchet MS',verdana;">
    <div style="z-index:1;">
<table border='1' width="100%" height="100%" cellpadding="5" cellspacing="0" border="0">
<tr>

<!-- ============ HEADER SECTION ============== -->
<td colspan="4" valign="center" style="height: 120px;"  >
    <h1>&nbsp;&nbsp;All events for userID: ${studentid}</h1>
...
<td colspan='3' width="25%" valign="top" >
    You can decide what events you wish to participate in here.
    ${block}
</td>
